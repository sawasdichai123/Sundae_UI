...
async function run() {
  ...
  try {
    // 1. Sundae Reference
    await page.goto(`${SUNDAE}/login`, { waitUntil: 'networkidle' });
    await snap(page, 'sundae_flow1_sundae_login.png');
    ...
    // 3. Flow 5 Forgot & Reset Pass (do this before logging in)
